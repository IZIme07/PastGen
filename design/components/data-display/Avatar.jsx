/**
 * Avatar — person portrait. Shows a photo when `src` is set, otherwise
 * initials on a deterministic warm tint. Optional confidence `ring` color,
 * a `lifespan` deceased marker, and `gender` tint accents.
 */
export function Avatar({
  name = "",
  src,
  size = 44,
  ring,            // CSS color for an outer confidence/branch ring
  deceased = false,
  style = {},
  onClick,
}) {
