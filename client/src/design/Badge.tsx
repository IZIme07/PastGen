...
export type BadgeTone =
  | "neutral" | "brand" | "accent" | "confirmed" | "probable"
  | "inferred" | "hypothesis" | "conflict" | "info";
...
/** Badge — компактная пилюля статуса/категории на семантической палитре. */
export function Badge({ children, tone = "neutral", icon, dot = false, size = "md", style = {} }: BadgeProps) {
