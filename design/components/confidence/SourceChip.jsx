...
/**
 * SourceChip — provenance marker. Every claim cites its sources; this chip
 * shows the source TYPE with its icon + tint, and an optional title/quality.
 */
const SOURCE_TYPES = {
...
export function SourceChip({
  type = "document",
  label,                 // overrides the default type label
  quality,               // optional 0–100 source quality, shown as a small dot scale
  onClick,
  removable = false,
  onRemove,
  style = {},
